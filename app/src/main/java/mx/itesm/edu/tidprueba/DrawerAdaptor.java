...
/**
 * Created by karlagamboa on 12/02/15.
 */
...
public class DrawerAdaptor extends ArrayAdapter<Objeto> {
     ...
     */
    public DrawerAdaptor(Context mContext, int layoutResourceId, Objeto[] data) {
